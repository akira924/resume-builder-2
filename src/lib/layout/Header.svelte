...
<header class="h-14 shrink-0 flex items-center justify-between px-6 bg-white dark:bg-gray-900 text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-700">
  <span class="text-lg font-semibold tracking-wide">Resume Builder</span>
