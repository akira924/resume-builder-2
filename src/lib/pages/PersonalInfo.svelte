...
<div class="max-w-2xl mx-auto space-y-8">
  <div>
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100">Personal Information</h1>
    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Add your contact details so employers can reach you.</p>
  </div>

  <!-- Required fields -->
  <section class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-5">
    <h2 class="text-lg font-semibold text-gray-700 dark:text-gray-200">Basic Details</h2>
  ...
  <section class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6 space-y-5">
    <div>
      <h2 class="text-lg font-semibold text-gray-700 dark:text-gray-200">Online Presence</h2>
      <p class="mt-0.5 text-xs text-gray-400 dark:text-gray-500">Optional — add links to your professional profiles.</p>
    </div>
